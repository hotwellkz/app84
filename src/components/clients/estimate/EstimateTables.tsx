  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <div className="bg-blue-100 p-2 sm:p-3 rounded-lg shadow">
          <div className="flex justify-between items-center">
            <span className="font-bold text-blue-800 text-xs sm:text-base">ИТОГО ОБЩАЯ:</span>
            <span className="font-bold text-blue-800 text-xs sm:text-base">{formatAmount(grandTotal)}</span>
          </div>
        </div>

        <div className={`${netIncome < 0 ? 'bg-red-100' : 'bg-green-100'} p-2 sm:p-3 rounded-lg shadow`}>
          <div className="flex justify-between items-center">
            <span className={`font-bold ${netIncome < 0 ? 'text-red-800' : 'text-green-800'} text-xs sm:text-base`}>
        ...
        <div className={`${actualProfit < 500000 ? 'bg-red-100' : 'bg-purple-100'} p-2 sm:p-3 rounded-lg shadow`}>
          <div className="flex justify-between items-center">
            <span className={`font-bold ${actualProfit < 500000 ? 'text-red-800' : 'text-purple-800'} text-xs sm:text-base`}>
